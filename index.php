...
<div class="signupbreaker">
	<div class="subcontainer">
		<p class="subcontainer-copy">Currently accepting students for September and October Classes</p>
	...
	<div class="homecontentcontainer">
		<div class="thecontent">
			<div class="theheading">
				<h2>CODESOUTH HAS THE TRAINING YOU NEED</h2>
			</div>
			...
			<div class="thereasons">
				...
				<div class="reason">
					<h4>Mentorship</h4>
					<p>Learn quickly from experienced developers that have been where you are and can offer one on one help.</p>
				</div>
				<div class="clearfix"></div>
			</div>
