<?php  
$pagetitle = "RESPONSIVE DESIGN BOOTCAMP";
$pagedescription = "Join us as we explore CSS techniques and design principles, including fluid grids, flexible images, and media queries, demonstrating how you can deliver a quality experience to your users no matter how large (or small) their display.";
		...
		<div class="classcontentinfo">
			...
			<div class="signupforthisclassinfo">
				...
				<div class="singupforthisclassbuttonholder">
					<a class="followresponsivedesign"><p class="signupforthisclassbutton">ATTEND</p></a>
				</div>
		...
		<div class="classcontentsocial">
			<div class="classcontentsocialcontainer">
				<div class="classcontentsocialcontact">
					<p>Have a question? <a href="../contact">Let us know</a>.</p>
				</div>
    	...
    	<h1>Stay updated</h1>
	     <p style="">Enter Your Email Address To Start Following.</p>
	        <div class="remodalemailform">
	        	<form>
		        	<input type="text" class="class-email" id="class-email" placeholder="email"><br />
		        	<input id="class-responsivedesignbootcamp-follow" class="classfollow" type="button" value="Follow Class" />
		        </form>
	       	</div>
    </div>
