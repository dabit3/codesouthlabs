...
<div class="classcontentcontainer">
	<div class="classcontentwrapper">
			...
			<div class="signupforthisclassinfo">
				...
				<div class="signupforthisclassheader">
					...
					<div class="signupforthisclasscopy">
						<p>Saturday, November 7<br /> 2015</p>
						<p>10:00am - 4:00pm</p>
					</div>
					<div class="clearfix"></div>

				</div>
				<h3 class="signupforthisclassh3">Regular Ticket &nbsp;&nbsp; <span>$60</span></h3>
				<div class="signupforthisclass">
				<div class="singupforthisclassbuttonholder">
					<a href="https://www.eventbrite.com/e/wordpress-bootcamp-tickets-18606977972">
		...
		<div class="classcontentsidebar">
			...
			<p class="sidebardate"><i class="fa fa-university"></i>Saturday, November 7 2015</p>
			<p class="sidebardate"><i class="fa fa-university"></i>December 2015</p>
			<p class="sidebardate"><i class="fa fa-university"></i>January 2016</p>
